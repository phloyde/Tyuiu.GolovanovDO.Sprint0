...
namespace Tyuiu.GolovanovDO.Sprint0.Task6.V0.Lib
{
    public class DataService
    {
        ...
        // Пример циклической структуры (циел с предусловием) while 
        ...
        // Пример циклической структуры (циел с предусловием) do while
